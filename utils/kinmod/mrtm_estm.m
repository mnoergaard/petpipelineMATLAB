function [Err,Par,yest,Par_cov,LogLike,AIC, MSE, FPE]=mrtm_estm(TimeTAC,FrameWeight,RefTAC,RoiTAC,Name)
%
%  function  [Err,Par,yest]=mrtm_estm(TimeTAC,FrameWeight,RefTAC,RoiTAC,Name)
%
