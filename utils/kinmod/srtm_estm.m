function [Err,Par,yest,Par_cov,LogLike,AIC, MSE, FPE]=srtm_estm(TimeTAC,FrameWeight,RefTAC,RoiTAC,Name,Iter)
%
...
for i=1:size(RoiTAC,2)
    ...
    if any(isnan(ydata))
        ...
        [Err(i), Par{i}, yest(:,i), Par_cov{i}, LogLike(i), AIC(i), MSE(i), FPE(i)]=EstmRefTissue;
    end
end
%

    function [Err, Par, yest, Par_cov, LogLike, AIC, MSE, FPE]=EstmRefTissue
        %
        %
        for k=1:Iter
